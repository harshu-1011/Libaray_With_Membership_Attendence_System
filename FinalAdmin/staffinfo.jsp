...
<body>
    ...
    <section class="home">
        <div class="text">Admin Dashboard
                <!-- <input type="button" value="Add Staff" name="Add Staff"/> -->
            <a href="staffadd.html"> <button>Add Staff</button></a>       
</div>
...
<HTML>
       ...
       <BODY BGCOLOR="cyan">
      <div class="text"> <H3>Staff Information</H3> 
    </div>
       <%
